...
function draw(){
    ...
    stroke("blue")
    strokeWeight(6)
    text("Press space key to play with Hyena",700,25)
...
function mouseDragged(){
    ...
    Matter.Body.setPosition(hyena.body, {x: mouseX , y: mouseY});
...
function keyPressed(){
    if(keyCode === 32){
       ...
       Matter.Body.setPosition(hyena.body, {x: 200 , y: 100});
        slingshot.attach(hyena.body)
